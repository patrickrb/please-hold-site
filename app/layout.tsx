...
export const metadata = {
  title: 'Please Hold — AI-Powered Scam Call Wasting',
  description: 'Please Hold is an AI that answers spam calls and politely wastes the caller\'s time. Weaponized politeness for the modern age.',
};
